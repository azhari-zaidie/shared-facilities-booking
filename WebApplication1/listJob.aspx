<%@ Page Title="List Of Departments" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="listJob.aspx.cs" Inherits="WebApplication1.listJob" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top" style="background: var(--bs-indigo);">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Departments Details</h3>
                    <div class="row mb-3">
                        <div class="col-lg-4">
                            <div class="row">
                                <div class="col">
                                    <div class="card shadow mb-3">
                                       ...
                                       <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="first_name"><strong>Department ID</strong></label>
                                                            <asp:TextBox  class="form-control form-control-user"  ID="txtDepartmentId" runat="server" style="color: rgb(0,0,0);" ReadOnly="true"></asp:TextBox>
                                                            <label class="form-label" for="first_name"><strong>Department Name</strong></label>
                                                            <asp:TextBox  class="form-control form-control-user"  ID="txtDepartment" runat="server" style="color: rgb(0,0,0);" placeholder="Enter Department Name..."></asp:TextBox>
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col">
                                    <div class="card shadow mb-3">
                                        <div class="card-header py-3">
                                            <p class="text-primary m-0 fw-bold">List Of Department</p>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                            ...
                                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dbCon %>" SelectCommand="SELECT * FROM [departments]"></asp:SqlDataSource>
                                                   <div class="table-responsive table mb-0 pt-3 pe-2">
                                                  <asp:GridView ID="GridView1" runat="server" class="table table-bordered" style="width:100%" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" DataKeyNames="dept_id" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                                                      <Columns>
