<%@ Page Title="" Language="C#" MasterPageFile="~/emp.Master" AutoEventWireup="true" CodeBehind="managerBranchDetails.aspx.cs" Inherits="WebApplication1.managerBranchDetails" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top" style="background: var(--bs-indigo);">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Branch Details</h3>
                    <div class="row mb-3">
                        <div class="col-lg-4">
                            <div class="card mb-3">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    ...
                                    <h6 class="text-primary fw-bold m-0">Manager Details                                        <asp:Button ID="btnPrint" class="btn btn-success btn-sm float-right" runat="server" Text="Print Details" OnClientClick="javascript:PrintPage();" />
</h6></div>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <div class="mb-3">
                                                <label class="form-label"><strong>Manager Name</strong></label>
                                                <asp:TextBox  class="form-control form-control-user"  ID="txtManagerName" runat="server" style="color: rgb(0,0,0);" ReadOnly="true"></asp:TextBox>
                                            </div>
                                        </div>
                                        </div>
                                        <div class="row">
                                            <div class="col">
                                                <div class="mb-3">
                                                     <label class="form-label"><strong>Manager Address</strong></label>
                                                    <asp:TextBox  class="form-control form-control-user"  ID="txtManagerAddress" runat="server" style="color: rgb(0,0,0);" ReadOnly="true"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div> 
                                </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="card shadow">
                                        <div class="card-header py-3">
                                            <p class="text-primary m-0 fw-bold">Branch Details</p>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <asp:TextBox  class="form-control form-control-user"  ID="txtBranchId" runat="server" style="color: rgb(0,0,0);" Visible="false"></asp:TextBox>
                                            </div>
                                            <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3">
                                                            <label class="form-label" for="username"><strong>Branch Name</strong></label>
                                                    ...
                                                    <div class="col">
                                                        <div class="mb-3">
                                                            <label class="form-label"><strong>Branch Date</strong></label>
                                                            <asp:TextBox  class="form-control form-control-user"  ID="txtBranchDate" runat="server" style="color: rgb(0,0,0);" ReadOnly="true"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label"><strong>Postal Code</strong></label>
                                                            <asp:TextBox  class="form-control form-control-user"  ID="txtBranchPostalCode" runat="server" style="color: rgb(0,0,0);" ReadOnly="true"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="country"><strong>Status</strong></label>
                                                            <asp:DropDownList ID="drpStatus" class="browser-default custom-select" runat="server">
                                                                <asp:ListItem Value="Available"></asp:ListItem>
                                                                <asp:ListItem Value="Unavailable"></asp:ListItem>
                                                            </asp:DropDownList>
                                                        </div>
                                                    </div>
                                                    <div class="mb-3"><asp:Button ID="btnSave" class="btn btn-primary d-block btn-user w-100" runat="server" Text="Save Settings" OnClick="btnSave_Click" />
