<%@ Page Title="" Language="C#" MasterPageFile="~/emp.Master" AutoEventWireup="true" CodeBehind="managerEmpDetails.aspx.cs" Inherits="WebApplication1.managerEmpDetails" %>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="username"><strong>Salary</strong></label>
                                                            <asp:TextBox  class="form-control form-control-user"  ID="txtEmpSalary" runat="server" style="color: rgb(0,0,0);"></asp:TextBox>
                                                            <small class="text-danger">
