<%@ Page Title="" Language="C#" MasterPageFile="~/emp.Master" AutoEventWireup="true" CodeBehind="managerEmpList.aspx.cs" Inherits="WebApplication1.managerEmpList" %>
                 ...
                 <div class="container-fluid">
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold"><asp:Label ID="lblBranchname" class="text-primary m-0 fw-bold" runat="server" Text="Label"></asp:Label> Employee Info</p>
                            <asp:TextBox ID="txtBranchid" runat="server" BorderStyle="None" Visible="False"></asp:TextBox>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive table mb-0 pt-3 pe-2">
                              <asp:GridView ID="GridView1" runat="server" class="table table-bordered" style="width:100%" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" DataKeyNames="emp_id">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="emp_date" HeaderText="Employee Date" SortExpression="emp_date" />
                                    <asp:BoundField DataField="branch_name" HeaderText="Branch_Name" Visible="False"  SortExpression="branch_name" />
                                    ...
                                    <asp:hyperlinkfield  Text="<i class='fas fa-edit'></i>" datanavigateurlfields="emp_id" HeaderText="Action" datanavigateurlformatstring="~\managerEmpDetails.aspx?emp_id={0}" HeaderStyle-Width="5%"/>   
                                    <asp:hyperlinkfield  Text="<i class='fas fa-trash'></i>" datanavigateurlfields="emp_id" datanavigateurlformatstring="~\managerEmpList.aspx?del={0}"  /> 
                                </Columns>
                            </asp:GridView>
                               <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dbCon %>" SelectCommand="select e.emp_id, e.emp_name, e.emp_address, e.emp_salary, e.emp_date, d.dept_name, b.branch_name, j.job_name from employee e, departments d, branch b, job j where e.dept_id = d.dept_id and e.job_id = j.job_id and e.branch_id=b.branch_id and b.branch_id = @branch;">
                                   <SelectParameters>
                                       <asp:ControlParameter ControlID="txtBranchid" Name="branch" PropertyName="Text" />
                                   </SelectParameters>
                                </asp:SqlDataSource>
