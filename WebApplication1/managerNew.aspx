<%@ Page Title="Manager" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="managerNew.aspx.cs" Inherits="WebApplication1.managerNew" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top" style="background: var(--bs-indigo);">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Add New Manager</h3>
                    <div class="row mb-3">
                        <div class="col-lg-2">
                        </div>
                        <div class="col-lg-8">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="username"><strong>Email</strong></label>
                                                            ...
                                                            <small class="text-danger">
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="txtManagerEmail" Display="Dynamic" SetFocusOnError="True">*Email is required</asp:RequiredFieldValidator>
                                                                 </small>
                                                        </div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label"><strong>Phone</strong></label>
                                                            ...
                                                            <small class="text-danger">
                                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="RegularExpressionValidator" ControlToValidate="txtManagerPhone" Display="Dynamic" ValidationExpression="^(\+?6?01)[0-46-9]-*[0-9]{7,8}$">*Invalid Phone number</asp:RegularExpressionValidator>
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="txtManagerPhone" Display="Dynamic" SetFocusOnError="True">*Phone is required</asp:RequiredFieldValidator>
                                                                 </small>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="first_name"><strong>Address</strong></label>
                                                            ...
                                                            <small class="text-danger">
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="txtManagerAddress" Display="Dynamic" SetFocusOnError="True">*Address is required</asp:RequiredFieldValidator>
                                                                 </small>
                                                        </div>
                                                    </div>
                                                </div>
                                            <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="username"><strong>Password</strong></label>
                                                            ...
                                                            <small class="text-danger">
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="txtPassword" Display="Dynamic" SetFocusOnError="True">*Password is required</asp:RequiredFieldValidator>
                                                                    <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="CompareValidator" ControlToCompare="txtPassword" ControlToValidate="txtConfirmPassword" Display="Dynamic" ForeColor="Red" SetFocusOnError="True">*Password and Confirm Password need to be same</asp:CompareValidator>
                                                    ...
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label"><strong>Confirm Password</strong></label>
                                                            ...
                                                            <small class="text-danger">
                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="txtConfirmPassword" Display="Dynamic" SetFocusOnError="True">*Confirm Password is required</asp:RequiredFieldValidator>
                                                                 </small>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="mb-3">
                                                    <asp:Button ID="btnInsert" class="btn btn-primary d-block btn-user w-100" runat="server" Text="Add New Manager" OnClick="btnInsert_Click"/>
                                                </div>
                                        </div>
                                    </div>
                                </div>
