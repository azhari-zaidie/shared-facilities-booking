<%@ Page Title="Profile" Language="C#" MasterPageFile="~/emp.Master" AutoEventWireup="true" CodeBehind="managerProfile.aspx.cs" Inherits="WebApplication1.managerProfile" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top" style="background: var(--bs-indigo);">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Profile Details</h3>
                    <div class="row mb-3">
                        <div class="col-lg-4">
                            <div class="card mb-3">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="username"><strong>Username</strong></label>
                                                            <asp:TextBox  class="form-control form-control-user"  ID="txtManagerUsername" runat="server" style="color: rgb(0,0,0);" placeholder="Enter Manager Username..." ReadOnly="true"></asp:TextBox>
                                                            <small class="text-danger">
